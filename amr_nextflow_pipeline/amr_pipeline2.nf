...
params.threads = 32
params.reads = "/home1/amr31/AMR_FASTQ/trimmed/*_{R1,R2}.fastq.gz"
...
// process 0: Quality check (optional, can be skipped if not needed)
process initial_fastqc {
    tag "${sample}"
    publishDir "${params.outdir}/00_Initial_QC", mode: 'copy', 
...
workflow {
    ...
    FASTQC_OUT = initial_fastqc(read_pairs)
